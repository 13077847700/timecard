        ...
        <div class="row">
            <div class="col-xs-12">
                <form class="form-horizontal" id="form" method="post" action="<?php echo U('update');?>">
                    ...
                    <input type="hidden" name="id" value="<?php echo ($department["id"]); ?>" id="id"/>
                    ...
                    <div class="form-group">
                        <label class="col-sm-1 control-label no-padding-right" for="form-field-1">
                            部门名称 </label>
                        <div class="col-sm-9">
                            <input type="text" name="dept_name" id="dept_name" placeholder="部门名称"
                                   class="col-xs-10 col-sm-5" value="<?php echo ($department['dept_name']); ?>">
                            <span class="help-inline col-xs-12 col-sm-7">
                                        <span class="middle">部门名称不能为空。</span>
                                    </span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                                <textarea name="remark" id="remark" placeholder="备注"
                                          class="col-sm-5"
                                          rows="5"><?php echo ($department['remark']); ?></textarea>
                            <span class="help-inline col-xs-12 col-sm-7">
                                <span class="middle">部门备注</span>
                            </span>
                        </div>
                    </div>
