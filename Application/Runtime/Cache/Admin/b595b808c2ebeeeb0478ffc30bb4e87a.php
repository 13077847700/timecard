        ...
        <div class="col-md-12">
            ...
            <div class="portlet box green">
                <div class="portlet-title">
                    <div style="line-height:40px;margin-left:10px;font-size:25px;">
                    ...
                    <div class="table-scrollable">
                        <table class="table table-striped table-hover">
                            <tbody>
                                ...
                                <tr>
                                    <td>MYSQL版本 </td>
                                    <td> 		<?php $system_info_mysql = M()->query("select version() as v;"); ?>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title" style="font-size:25px;">日志内容</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
