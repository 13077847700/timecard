            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" action="<?php echo U('update');?>" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <?php if($member['id'] == 1): ?>readonly
                                <?php else: ?>
                                name="user"<?php endif; ?>
                            class="rcol-xs-10 col-sm-5" value="<?php echo ($member["username"]); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <?php if($member['id'] == 1): if(is_array($usergroup)): $i = 0; $__LIST__ = $usergroup;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i; if($val['id'] == $member['group_id']): ?><input type="text" class="col-xs-10 col-sm-5" value="<?php echo ($val['title']); ?>"
                                               readonly>
