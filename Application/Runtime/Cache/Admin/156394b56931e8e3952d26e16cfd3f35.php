        ...
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" action="<?php echo U('update');?>" method="post">
                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right" for="form-field-10">
                        上级菜单 </label>
                ...
                <div class="form-group">
                    ...
                    <div class="control-label no-padding-left col-sm-1" style="text-align:left;">
                        <label>
                ...
                <div class="space-4"></div>
                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right" for="form-field-2"> 页面提示</label>
                    <div class="col-sm-9">
