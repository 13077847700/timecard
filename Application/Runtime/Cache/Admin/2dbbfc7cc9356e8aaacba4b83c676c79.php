            ...
            <div class="col-xs-12">
                ...
                <div class="cf">
                    <form class="form-inline" action="" method="get">
                        <a class="btn btn-info" href="<?php echo U('add');?>" value="">+新增部门</a>

                        <input type="text" name="keyword" value="<?php echo I('keyword');?>" class="" placeholder="关键字搜索" class="form-control">
                ...
                <form id="form" method="post" action="<?php echo U('del');?>">
                    <table class="table table-striped table-bordered">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><a href="<?php echo U('index');?>?sid=<?php echo ($val['sid']); ?>" title="<?php echo ($val['dept_name']); ?>"><?php echo ($val['dept_name']); ?></a>
                                </td>
                                <td><?php echo ($val['remark']); ?></td>
                                <td><a href="<?php echo U(edit);?>?id=<?php echo ($val['id']); ?>"><i
                                        class="ace-icon fa fa-pencil bigger-100"></i>修改</a>&nbsp;&nbsp;<a
                                        href="javascript:;" val="<?php echo U('del');?>?ids=<?php echo ($val['id']); ?>" class="del"><i
